...
const DashboardMe = () => {
  ...
  return (
    <div className="p-6 max-w-md mx-auto bg-white min-h-screen">
      ...
      {/* User Info Card */}
      <Card className="glass-card p-6 mb-6 relative overflow-hidden">
      ...
      <Card className="glass-card p-4 mb-6 border-green-500/30">
        <div className="flex items-center space-x-3">
      ...
      {isAdmin && (
        <Card className="glass-card p-4 mb-6 border-orange-500/30">
          <div className="flex items-center space-x-3">
