...
if (/android/i.test(userAgent)) {
  ...
  window.open('[https://play.google.com/store/apps/details?id=com.zerthyx.app](https://play.google.com/store/apps/details?id=com.zerthyx.app)', '_blank');
} else if (/iPad|iPhone|iPod/.test(userAgent)) {
  // iOS - Open App Store
  window.open('[https://apps.apple.com/app/zerthyx/id123456789](https://apps.apple.com/app/zerthyx/id123456789)', '_blank');
} else {
...
<Settings className="w-5 h-5" />
  ...
  {/* User Info Card */}
  <Card className="p-6 mb-6 relative overflow-hidden" style={{ backgroundColor: '#CCCC00' }}> {/* डार्क पीला रंग */}
  ...
  {/* Quick Links Section */}
  <div className="mb-6">
    <h2 className="text-lg font-bold mb-4 flex items-center" style={{ color: 'black' }}> {/* ब्लैक कलर */}
      ...
      {quickLinks.map((link) => {
        ...
        return (
          <Card
            ...
            onClick={link.action}
            style={{ backgroundColor: '#E0E0E0' }} {/* हल्का ग्रे रंग */}
          >
  ...
  <Card className="p-4 mb-6 border-green-500/30" style={{ backgroundColor: '#E0E0E0' }}> {/* हल्का ग्रे रंग */}
    <div className="flex items-center space-x-3">
  ...
  {isAdmin && (
    <Card className="p-4 mb-6 border-orange-500/30" style={{ backgroundColor: '#E0E0E0' }}> {/* हल्का ग्रे रंग */}
      <div className="flex items-center space-x-3">
  ...
  <AlertDialog>
    <AlertDialogTrigger asChild>
      <Button
        ...
        style={{ backgroundColor: 'red', color: 'black' }} {/* रेड बैकग्राउंड, ब्लैक टेक्स्ट */}
      >
        <LogOut className="w-5 h-5 mr-2" />
        Logout
      </Button>
    </AlertDialogTrigger>
    <AlertDialogContent className="glass-card" style={{ backgroundColor: '#E0E0E0' }}> {/* हल्का ग्रे रंग */}
      <AlertDialogHeader>
