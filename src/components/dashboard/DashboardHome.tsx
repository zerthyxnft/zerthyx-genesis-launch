...
  return (
    <div className="w-full min-h-screen bg-white p-4 space-y-6 text-gray-900">
      {/* Header */}
...
      {/* ---------- 45 Day Countdown Timer (light blue) ---------- */}
      {walletData.nft_maturity_date && (
...
            <Progress value={progressPercentage} className="h-2 bg-blue-300 [&>div]:bg-gradient-to-r [&>div]:from-cyan-400 [&>div]:to-blue-400" />
...
      {/* ---------- Profit Withdrawal Button (light blue) ---------- */}
...
          <DialogHeader>
            <DialogTitle className="text-gray-900">Deposit USDT</DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            <div>
...
                    className="bg-blue-100 text-gray-800 border-blue-200 hover:bg-blue-200"
                  >
                    ${amount}
                  </Button>
                ))}
...
                    <SelectTrigger className="mt-2 bg-blue-50 border-blue-200">
                      <SelectValue />
                    </SelectTrigger>
...
        <DialogContent className="bg-white rounded-xl p-4">
          <DialogHeader>
            <DialogTitle className="text-gray-900">WITHDRAW USDT</DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            {/* Blockchain Select */}
            <div>
...
                className="mt-2 bg-blue-50 border-blue-200 text-gray-900"
              />
...
      {/* ---------- Withdrawals List (light blue card) ---------- */}
      <div className="w-full bg-blue-50 rounded-xl p-4">
